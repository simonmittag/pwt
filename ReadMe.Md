...
pwt ("port wait") waits for you until a tcp socket, aka port becomes available and exits once it does. Designed for 
continuous integration scripts, never call sleep again.
pipeline.
